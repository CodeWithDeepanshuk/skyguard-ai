...
* **Parameter Provenance Registry**: [`docs/PARAMETER_PROVENANCE.md`](PARAMETER_PROVENANCE.md) | **Configurations**: [`config/`](../config/)
...
Configured in [`config/regional_qc.yaml`](../config/regional_qc.yaml) and verified in [`src/skyguard/quality/indian_regional_bounds.py`](file:///c:/Users/deepa/OneDrive/Desktop/Sih%2073/src/skyguard/quality/indian_regional_bounds.py):
