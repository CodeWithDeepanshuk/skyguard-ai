...
export async function GET() {
  try {
    ...
    const summary = {
      ...
      observation_records: reportingCount > 0 ? 884 : 0,
      ...
      reporting_by_source: {
        METAR: 86,
        IMD_AWS_CONSENSUS: stations.length - 86,
      },
      storage: {
        backend: 'sqlite',
        durable: false,
      ...
      catalog_basis: 'NOAA/ISD station metadata used by the Iteration 11 national catalog',
